...
# Add the braincomua_bs_project directory to Python path
project_path = os.path.join(root_path, 'braincomua_bs_project')
sys.path.insert(0, project_path)

# Name of Django settings module and project
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "braincomua_bs_project.settings")
